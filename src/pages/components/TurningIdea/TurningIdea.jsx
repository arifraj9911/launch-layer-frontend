  ...
  return (
    <div className="flex justify-center items-center px-4 py-24">
      <div className="relative z-10 max-w-4xl w-full p-[1.5px] rounded-[32px] bg-gradient-to-b from-[#3063D3] to-black shadow-xl">
        <div className="relative rounded-[30px] bg-[#030B1C] p-10 md:p-16 text-center text-white overflow-hidden">
          {/*  Blur Effect */}
          <div
          ...
          {/* Content */}
          <h2 className="text-3xl md:text-[56px] font-semibold mb-3 leading-snug relative z-10">
            Let’s Turn Your <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            <button
              className="text-white px-6 py-3 rounded-lg text-xl font-medium"
              style={{
                background:
            ...
            <button className="text-white px-6 py-3 rounded-lg text-xl font-medium border border-white/80">
              Contact Us
            </button>
          </div>
        </div>
